...
def test_add_product(token):
    ...
    """
    payload = {
        "name": "dumbell", # Change product name
        "type": "Gym", # Change type/category
        "sku": "gym-006", # Change SKU if needed
        "image_url": "https://example.com/dumbell.jpg", # Change image URL
        "description": "dumbells", # Change description
